...
func (prj *BallisticProjectile) IsActiveIfContinuous() bool {
    return true
}

func (prj *BallisticProjectile) Update(_, _ rl.Vector2) bool {
...
func NewBallisticProjectile(position, direction rl.Vector2, projectileConfig ProjectileConfig) *BallisticProjectile {
